...
#define BT_UUID_HW_STATUS_VAL \
    BT_UUID_128_ENCODE(0x45622514, 0x6468, 0x465a, 0xb141, 0x0b9b0f96b468)
...
#define BT_UUID_HW_STATUS        BT_UUID_DECLARE_128(BT_UUID_HW_STATUS_VAL)
